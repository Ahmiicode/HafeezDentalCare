...
export const metadata = {
  metadataBase: new URL("https://hafeezdentalcare.com"),

  title: {
    default: "Hafeez Dental Care | Dentist in Rahim Yar Khan",
    template: "%s | Hafeez Dental Care",
  },

  description:
    "Hafeez Dental Care provides professional dental care in Rahim Yar Khan, including dental implants, root canal treatment, teeth whitening, dental crowns and cosmetic dentistry.",

  keywords: [
    "dentist in Rahim Yar Khan",
    "best dentist in Rahim Yar Khan",
    "dental clinic in Rahim Yar Khan",
    "dentist Rahim Yar Khan",
    "dental treatment Rahim Yar Khan",
    ...
    "cosmetic dentistry Rahim Yar Khan",
    "Hafeez Dental Care",
    "Dr. Shahrukh Hafeez",
  ],
  ...
  authors: [
    {
      name: "Hafeez Dental Care",
    },
  ],

  creator: "Hafeez Dental Care",

  publisher: "Hafeez Dental Care",

  alternates: {
    canonical: "https://hafeezdentalcare.com",
  },

  openGraph: {
    title: "Hafeez Dental Care | Dentist in Rahim Yar Khan",

    description:
      "Professional dental care and treatment in Rahim Yar Khan at Hafeez Dental Care.",

    url: "https://hafeezdentalcare.com",

    siteName: "Hafeez Dental Care",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hafeez Dental Care - Dentist in Rahim Yar Khan",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "Professional dental care and treatment in Rahim Yar Khan.",
