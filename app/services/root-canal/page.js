        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          ...
          <motion.div {...fadeUp} className="max-w-2xl">
            ...
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-4 py-2 text-sm font-medium text-[#2147FF]">
              ...
              Root Canal Treatment · Rahim Yar Khan
            </div>
            ...
            <p className="mt-7 max-w-xl text-[17px] leading-8 text-slate-500 md:text-lg">
              Root canal treatment helps treat infected or damaged teeth while
              preserving your natural tooth and protecting your smile.
            </p>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-blue-50 p-3 shadow-[0_25px_80px_rgba(33,71,255,0.08)]">
              ...
              <div className="relative h-[430px] overflow-hidden rounded-[1.5rem] sm:h-[500px]">
                ...
                <Image
                  src="/images/services/root-canal.jpg"
                  alt="Root canal treatment at Hafeez Dental Care"
                  fill
                  priority
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-lg leading-8 text-slate-500">
                When the inside of a tooth becomes infected or inflamed,
                root canal treatment can help remove the source of the
                problem and save the natural tooth.
              </p>

              <p className="mt-5 leading-8 text-slate-500">
                The goal is not simply to treat the tooth, but to protect
                your oral health and help you return to comfortable everyday
                eating and smiling.
              </p>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <motion.div {...fadeUp} className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-500">
              Root canal treatment can help resolve problems inside the tooth
              while allowing you to keep your natural smile.
            </p>
            ...
            {[
              {
                ...
                text: "Treatment can help preserve your natural tooth instead of removing it.",
              },
              {
                number: "02",
                title: "Relieve Discomfort",
                text: "Treating the source of infection can help reduce tooth-related pain and discomfort.",
              },
              {
                number: "03",
                title: "Protect Your Smile",
                text: "Keeping your natural tooth helps maintain your existing smile and bite.",
              },
              {
                number: "04",
                title: "Restore Function",
                text: "After treatment and restoration, you can return to normal everyday use of your tooth.",
              },
            ].map((item) => (
              <motion.div
                key={item.number}
            ...
            {[
              {
                step: "01",
                title: "Examination",
                text: "We examine the affected tooth and understand your symptoms before planning treatment.",
              },
              {
                step: "02",
                title: "Root Canal Treatment",
                text: "The infected or inflamed tissue inside the tooth is carefully treated.",
              },
              {
                step: "03",
                title: "Tooth Restoration",
                text: "The treated tooth is restored to help protect it and return normal function.",
              },
            ].map((item) => (
              <motion.div
                key={item.step}
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:px-8 lg:items-center">
          ...
          <motion.div {...fadeUp}>
            ...
            <p className="mt-6 leading-8 text-slate-500">
              Tooth pain, sensitivity, swelling, or discomfort can have
              different causes. A dental examination can help identify what
              is happening and whether root canal treatment may be needed.
            </p>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-7 text-blue-100/70">
              Schedule a consultation with Hafeez Dental Care and get your
              tooth checked by a dental professional.
            </p>
