export default function AboutDoctor() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-[-180px] top-1/3 h-[420px] w-[420px] rounded-full bg-blue-500/[0.05] blur-[130px]" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20 lg:px-8">
        ...
        <div className="relative mx-auto w-full max-w-[500px]">
          ...
          {/* Glow */}
          <div className="absolute -inset-5 rounded-[3rem] bg-blue-500/[0.06] blur-3xl" />

          {/* Image Frame */}
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-2.5 shadow-[0_25px_70px_rgba(15,23,42,0.08)]">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[1.5rem] bg-slate-100">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="rounded-2xl border border-white/70 bg-white/95 p-5 shadow-xl backdrop-blur-md">
          ...
          <div className="absolute -right-3 top-10 hidden rounded-2xl border border-blue-100 bg-white px-4 py-3 shadow-xl sm:block">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-9 grid max-w-xl gap-4 sm:grid-cols-2">
            ...
            {/* Card 1 */}
            <div className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-100 hover:shadow-lg hover:shadow-blue-900/[0.06]">
          ...
          <a
            href="#appointment"
            className="group mt-9 inline-flex items-center gap-3 rounded-full bg-[#2147FF] px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/20 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#081B4B]"
          >
            Book an Appointment
