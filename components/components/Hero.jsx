...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-[-140px] top-32 h-[320px] w-[320px] rounded-full bg-blue-500/[0.04] blur-[90px] sm:h-[420px] sm:w-[420px] sm:blur-[120px]" />

      <div className="pointer-events-none absolute bottom-[-140px] right-[-80px] h-[350px] w-[350px] rounded-full bg-cyan-400/[0.04] blur-[100px] sm:h-[450px] sm:w-[450px] sm:blur-[130px]" />

      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-6 pb-16 pt-32 sm:gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
        {/* LEFT CONTENT */}
        ...
        <motion.div
          {...visualAnimation}
          className="relative mx-auto flex min-h-[430px] w-full max-w-[520px] items-center justify-center sm:min-h-[500px]"
        >
          {/* Glow */}
          <div className="pointer-events-none absolute h-[280px] w-[280px] rounded-full bg-blue-500/[0.08] blur-[70px] sm:h-[450px] sm:w-[450px] sm:blur-[100px]" />

          {/* Main Orb */}
          <div className="relative flex h-[340px] w-[340px] items-center justify-center rounded-full border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-slate-50 shadow-[0_20px_70px_rgba(33,71,255,0.08)] sm:h-[480px] sm:w-[480px]">
            {/* Rings */}
            <div className="absolute h-[250px] w-[250px] rounded-full border border-blue-100 sm:h-[370px] sm:w-[370px]" />

            <div className="absolute h-[185px] w-[185px] rounded-full border border-blue-100/70 sm:h-[285px] sm:w-[285px]" />

            {/* Center */}
            <div className="relative z-10 flex h-28 w-28 items-center justify-center rounded-full bg-white shadow-[0_15px_45px_rgba(15,23,42,0.08)] sm:h-40 sm:w-40">
            ...
            {/* Orbit Lines */}
            <div className="absolute h-[290px] w-[135px] rotate-[35deg] rounded-[50%] border border-blue-200/60 sm:h-[420px] sm:w-[190px]" />

            <div className="absolute h-[290px] w-[135px] rotate-[-35deg] rounded-[50%] border border-cyan-200/50 sm:h-[420px] sm:w-[190px]" />

            {/* Floating Circle */}
            <div className="absolute right-[-5px] top-10 flex h-14 w-14 items-center justify-center rounded-full border border-blue-100 bg-white shadow-lg sm:right-[-12px] sm:h-20 sm:w-20">
              <span className="text-xl font-semibold text-[#2147FF]">+</span>
            </div>

            {/* Floating Info */}
            <div className="absolute bottom-8 left-[-5px] rounded-2xl border border-slate-100 bg-white px-4 py-3 shadow-lg sm:bottom-10 sm:left-[-25px] sm:px-5 sm:py-4">
            ...
            {/* Small Dots */}
            <div className="absolute bottom-7 right-12 flex gap-1.5 sm:bottom-8 sm:right-16">
              <span className="h-2 w-2 rounded-full bg-[#2147FF]" />
